...
public struct Key {
    ...
    public init(key: String, value: CGFloat? = nil, color: FLColor, disableColor: FLColor) {
        self.key = key
        self.value = value
        self.color = color
    ...
    public init(key: String, xColors: [UIColor], disableColor: UIColor) {
        self.key = key
        self.color = FLColor(colors: xColors, segmentedGradient: true)
        self.disableColor = FLColor(colors: [disableColor], segmentedGradient: true)
    }
    ...
    public init(key: String, yThresholds: [CGFloat : UIColor], data: [PlotableData], disableColor: UIColor) {
        self.key = key
